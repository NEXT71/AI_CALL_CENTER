...
## Verified Package Versions (January 13, 2026)

These versions are tested and confirmed working together:

| Package | Version | Notes |
|---------|---------|-------|
| torch | 2.4.1+cu121 | CUDA 12.1 build |
| torchaudio | 2.4.1+cu121 | CUDA 12.1 build |
| numpy | 1.26.4 | ⚠️ MUST be <2.0 |
| fastapi | 0.115.0 | |
| uvicorn | 0.32.0 | |
| python-multipart | 0.0.12 | |
| python-dotenv | 1.0.1 | |
| pydantic | 2.10.3 | |
| transformers | 4.47.1 | |
| openai-whisper | 20250625 | Latest version |
| librosa | 0.10.2.post1 | |
| soundfile | 0.12.1 | |
| pydub | 0.25.1 | |
| ffmpeg-python | 0.2.0 | |
| spacy | 3.8.3 | |
| rapidfuzz | 3.10.1 | |
| pyannote.audio | 3.1.1 | Requires NumPy <2.0 |
| pytz | 2025.2 | Updated version |
| psutil | 6.1.0 | |