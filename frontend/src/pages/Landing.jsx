  ...
  const pricingPlans = [
    {
      ...
      price: '$0',
      period: '/forever',
      description: 'Perfect for testing AI scoring accuracy',
      features: [
    ...
    },
    {
      ...
      price: '$129',
      period: '/month',
      description: 'Perfect for QA Sampling (10-20% of deals)',
      features: [
    ...
    },
    {
      ...
      price: '$199',
      period: '/month',
      description: 'Bridge tier for expanding teams',
      features: [
    ...
    },
    {
      ...
      price: '$299',
      period: '/month',
      description: 'Best for Targeted QA & growing sales floors',
      features: [
        '4,000 minutes/month (~250-300 calls)',
        '$0.09/min overage rate',
        'Advanced AI (objection handling, scripts)',
        'Unlimited custom QA Scorecards',
        'Priority support (12hr) + live chat',
        '10 team members',
    ...
    },
    {
      ...
      price: '$899',
      period: '/month',
      description: 'For 100% Compliance & Full Floor Coverage',
      features: [
        ...
        'Unlimited API & parallel processing',
